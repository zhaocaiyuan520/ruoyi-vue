...
-- ----------------------------
DROP TABLE
    IF EXISTS sys_home_article;
CREATE TABLE sys_home_article
(
    article_id     BIGINT (20) NOT NULL auto_increment COMMENT '首页文章id',
...
(
    ...
    `labs`   				varchar(3000)  DEFAULT NULL COMMENT 'labs',
    `offices`   			varchar(3000)  DEFAULT NULL COMMENT 'offices',
