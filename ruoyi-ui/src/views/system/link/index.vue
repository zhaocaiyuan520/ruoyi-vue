<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="linkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="链接标题中文" align="center" prop="linkTitle" />
      <el-table-column label="链接标题英文" align="center" prop="linkTitleen" />
      <el-table-column label="链接URL地址" align="center" prop="linkUrl" />
      <el-table-column label="0:penn;1:meeting;2:journals" align="center" prop="linkType" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="链接标题中文" prop="linkTitle">
          <el-input v-model="form.linkTitle" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="链接标题英文" prop="linkTitleen">
          <el-input v-model="form.linkTitleen" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="链接URL地址" prop="linkUrl">
